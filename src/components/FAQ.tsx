...
function FAQItem({ faq, index, isOpen, onToggle }: {
    ...
    return (
        ...
        >
            ...
            >
                <span className="text-lg font-semibold text-white group-hover:text-[#ffffff] transition-colors pr-8">
                    {faq.question}
                </span>
                <motion.div
                    animate={{ rotate: isOpen ? 45 : 0 }}
                    transition={{ duration: 0.2 }}
                    className="flex-shrink-0 w-8 h-8 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-white/20 transition-colors"
                >
                    <svg
