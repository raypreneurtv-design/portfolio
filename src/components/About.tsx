            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6" ref={ref}>
                ...
                >
                    ...
                    <div className="text-center mb-20">
                        <p className="text-[#ffffff] font-bold mb-4 tracking-widest uppercase text-sm">
                            The Team
                        </p>
                        <h2 className="text-4xl md:text-5xl font-black text-white mb-6">
                            Built By Someone Who's<br />
                            <span className="text-[#ffffff]">Actually Done It</span>
                        </h2>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16">
                        ...
                        <div>
                            <p className="text-xl text-white/80 mb-8 leading-relaxed">
                                We're a small team that's been deep in AI automation since <span className="text-[#ffffff] font-semibold">February 2024</span>.
                            ...
                            >
                                <p className="text-sm text-[#ffffff] font-semibold mb-3">PROOF: TikTok Growth</p>
                        ...
                        <div className="space-y-6">
                            {stats.map((stat, index) => (
                                ...
                                >
                                    <span className="text-4xl md:text-5xl font-black text-[#ffffff] block mb-2">
                                        {stat.number}
                                    </span>
